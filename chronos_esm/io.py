...
from chronos_esm.config import OCEAN_GRID, ATMOS_GRID

def save_state_to_netcdf(
    ...
    ds = xr.Dataset(
        data_vars={
            # Ocean
            "ocean_temp": (("z", "y_ocn", "x_ocn"), temp_ocn, {"units": "K", "long_name": "Ocean Potential Temperature"}),
            "ocean_salt": (("z", "y_ocn", "x_ocn"), salt_ocn, {"units": "psu", "long_name": "Ocean Salinity"}),
            "ocean_u": (("z", "y_ocn", "x_ocn"), u_ocn, {"units": "m/s", "long_name": "Ocean Zonal Velocity"}),
            "ocean_v": (("z", "y_ocn", "x_ocn"), v_ocn, {"units": "m/s", "long_name": "Ocean Meridional Velocity"}),
            
            # Ice
            "ice_thickness": (("y_ocn", "x_ocn"), h_ice, {"units": "m", "long_name": "Sea Ice Thickness"}),
            "ice_concentration": (("y_ocn", "x_ocn"), a_ice, {"units": "1", "long_name": "Sea Ice Concentration"}),
            
            # Atmos
            "atmos_temp": (("y_atm", "x_atm"), temp_atm, {"units": "K", "long_name": "Atmospheric Temperature"}),
            "atmos_q": (("y_atm", "x_atm"), q_atm, {"units": "kg/kg", "long_name": "Specific Humidity"}),
            "atmos_u": (("y_atm", "x_atm"), u_atm, {"units": "m/s", "long_name": "Atmospheric Zonal Wind"}),
            "atmos_v": (("y_atm", "x_atm"), v_atm, {"units": "m/s", "long_name": "Atmospheric Meridional Wind"}),
