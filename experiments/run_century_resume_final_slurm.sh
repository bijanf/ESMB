#!/bin/bash
#SBATCH --job-name=chronos_final
#SBATCH --output=logs/resume_final_%j.log
#SBATCH --error=logs/resume_final_%j.err
...
echo "Starting Final Resume (Year 44, Ah=2e6, DT=60) at $(date)"
echo "Job ID: $SLURM_JOB_ID"

# Run
stdbuf -o0 -e0 python experiments/run_century_resume_final.py
