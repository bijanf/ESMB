#!/bin/bash
#SBATCH --job-name=chronos_robust
#SBATCH --output=logs/resume_robust_%j.log
#SBATCH --error=logs/resume_robust_%j.err
...
echo "Starting Robust Resume (Year 42, Ah=5e6) at $(date)"
echo "Job ID: $SLURM_JOB_ID"

# Run
stdbuf -o0 -e0 python experiments/run_century_resume_robust.py
