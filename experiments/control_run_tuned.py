...
def run_control(years: float = 1.0):
    ...
    output_dir = Path("outputs/control_run_tuned")
    output_dir.mkdir(parents=True, exist_ok=True)

    logger = c_log.setup_logger("control_run_tuned", output_dir / "model.log")
    ...
    # Tuned up from 1250.0 after fixing Time Sync bug (Snowball Earth 256K -> Target 288K)
