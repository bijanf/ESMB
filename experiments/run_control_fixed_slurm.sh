#!/bin/bash
#SBATCH --job-name=control_fixed
#SBATCH --output=logs/control_fixed_%j.log
#SBATCH --error=logs/control_fixed_%j.err
...
echo "Starting Fixed Control Run at $(date)"
echo "Parameters: r_drag=0.01, kappa_gm=2000.0 (Unit Mismatch Fixed)"
echo "Job ID: $SLURM_JOB_ID"

# Run the simulation for 100 years
stdbuf -o0 -e0 python experiments/control_run.py --years 100.0 --r_drag 0.01 --kappa_gm 2000.0 --suffix fixed
