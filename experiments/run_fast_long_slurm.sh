#!/bin/bash
#SBATCH --job-name=chronos_fast
#SBATCH --output=logs/fast_%j.log
...
echo "Starting Fast Long Run at $(date)"
echo "Job ID: $SLURM_JOB_ID"
echo "Node: $SLURMD_NODENAME"

# Run the simulation (2-stage python script)
stdbuf -o0 -e0 python experiments/run_fast_long.py
