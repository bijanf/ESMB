...
<!-- VALIDATION:START -->
_Validation of `outputs/century_physics/final_state.nc` (0.1-yr WOA spin-up, bathymetry + convective-noise fix) against WOA18 + ERA5, auto-generated by `experiments/make_readme_figures.py`. A perfect model has bias 0, corr 1, std ratio 1._
