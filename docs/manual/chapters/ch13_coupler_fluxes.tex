...
aerodynamic formulae \citep{vallis2017}. These express each surface flux as the
...
In control mode the net heat flux receives a Haney restoring term toward a fixed
