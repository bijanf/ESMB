...
(Chapter~\ref{chap:ch05_ocean_mixing}). A more fundamental consequence is in the
ocean dynamics: at T31 the fully prognostic-momentum core gives a geostrophic
overturning $20$--$40\times$ too large, so the \emph{production} AMOC is supplied
by a thermohaline closure instead (cross-referenced in
