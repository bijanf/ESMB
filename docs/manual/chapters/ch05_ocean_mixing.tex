...
The standard remedy is to taper the slope. \model{} replaces the conventional hard
...
The Redi tensor rotates an isotropic diffusivity $\kiso$ into the local isopycnal
...
hard switch---set $\kv$ to a huge value wherever $\Delta\dens<0$. \model{} rejects
...
removes it with a scale-selective \emph{biharmonic} (Shapiro) filter applied to the
