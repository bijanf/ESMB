...
with a bulk formula, and rains out supersaturation through a large-scale condensation closure
...
SST climatology. The quantitative scorecard is refreshed from the latest control run; a 30-year
...
\begin{enumerate}[leftmargin=*]
  ...
  \item \textbf{Tropical SST limits the convection.} The free-running coupled model carries a
    ...
    restoring toward WOA to remove that bias; the ITCZ is therefore partly \emph{earned} by the
