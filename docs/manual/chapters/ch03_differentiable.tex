...
single \jax{} program \citep{jax2018}. Every floating-point operation is recorded on a
...
which carries the \dino{} spectral atmosphere (vorticity, divergence, temperature variation,
log surface pressure, humidity), the ocean $(\uu,\vv,\ww,\Temp,\Salt,\psib,\dens,\mathrm{DIC})$,
