...
restoring} \citep{haney1971} of SST toward the WOA18 climatology $\SSTt$
\citep{locarnini2018woa}. The correction is a
...
estimates \citep{ipcc2021ar6}, and (crucially) the response is \emph{nonzero}, confirming that the
