...
\usepackage{enumitem}
\usepackage[strings]{underscore}   % literal _ in text (paths); still subscript in math
...
\newcommand{\softplus}{\ensuremath{\operatorname{softplus}}}  % usable in text or math
\newcommand{\Sv}{\ensuremath{\,\mathrm{Sv}}}   % Sverdrup, usable in text or math
